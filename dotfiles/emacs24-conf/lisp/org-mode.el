;;; package --- norang org
;;; Commentary:
;;;     generated with C-c C-v C-t in http://doc.norang.ca/org-mode.org
;;; Code:
...
(setq org-todo-keywords
      (quote ((sequence "TODO(t)" "NEXT(n)" "|" "DONE(d)")
	      (sequence "DISCUSS(D)" "TEMPORARYFIX(F)" "3RDPARTY")
...
(setq org-todo-keyword-faces
      (quote (("TODO" :foreground "red" :weight bold)
	      ...
	      ("DISCUSS" :foreground "dark magenta" :weight bold)
...
(setq org-html-head-extra "<link rel=\"stylesheet\" href=\"http://portemanteau.ca/css/org.css\" type=\"text/css\" />")
...
(setq org-publish-project-alist
      ...
      (quote (("portemanteau.ca"
               :base-directory "~/git/portemanteau.ca"
               :publishing-directory "/ssh:self@portemanteau.ca:/var/www/portemanteau.ca"
               :recursive t
               ...
               :section-numbers nil
               :table-of-contents nil
               :html-head "<link rel=\"stylesheet\" href=\"/css/org-mode.css\" type=\"text/css\" />"
               :author-info nil
               :creator-info nil)
              ("norang-extra"
...
(global-set-key (kbd "C-c C-p") 'bh/save-then-publish)
...
(setq org-clock-sound "/home/self/sounds/tngchime.wav")
